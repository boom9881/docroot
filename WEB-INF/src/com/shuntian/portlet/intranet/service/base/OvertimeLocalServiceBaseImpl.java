...
/**
 * Provides the base implementation for the overtime local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.shuntian.portlet.intranet.service.impl.OvertimeLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class OvertimeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements OvertimeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.shuntian.portlet.intranet.service.OvertimeLocalServiceUtil} to access the overtime local service.
	 */
	...
	@Override
	public Overtime addOvertime(Overtime overtime) throws SystemException {
		overtime.setNew(true);

		return overtimePersistence.update(overtime);
	}
	 ...
	 */
	@Override
	public Overtime createOvertime(long id) {
		return overtimePersistence.create(id);
	}
	...
	@Override
	public Overtime deleteOvertime(long id)
		throws PortalException, SystemException {
		return overtimePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Overtime deleteOvertime(Overtime overtime) throws SystemException {
		return overtimePersistence.remove(overtime);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Overtime.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return overtimePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return overtimePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return overtimePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return overtimePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Overtime fetchOvertime(long id) throws SystemException {
		return overtimePersistence.fetchByPrimaryKey(id);
	}
	...
	public Overtime getOvertime(long id)
		throws PortalException, SystemException {
		return overtimePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return overtimePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Overtime> getOvertimes(int start, int end)
		throws SystemException {
		return overtimePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOvertimesCount() throws SystemException {
		return overtimePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Overtime updateOvertime(Overtime overtime) throws SystemException {
		return overtimePersistence.update(overtime);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.shuntian.portlet.intranet.model.Overtime",
			overtimeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = overtimePersistence.getDataSource();
	...
	private OvertimeLocalServiceClpInvoker _clpInvoker = new OvertimeLocalServiceClpInvoker();
}