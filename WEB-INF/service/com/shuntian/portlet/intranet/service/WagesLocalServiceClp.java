 ...
 * @generated
 */
public class WagesLocalServiceClp implements WagesLocalService {
	public WagesLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.shuntian.portlet.intranet.model.Wages addWages(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(wages) });
		}
		catch (Throwable t) {
	...
	public com.shuntian.portlet.intranet.model.Wages findByU_M(long userId,
		...
		try {
			...
			if (t instanceof com.shuntian.portlet.intranet.NoSuchWagesException) {
				throw (com.shuntian.portlet.intranet.NoSuchWagesException)t;
			}
