...
import com.shuntian.portlet.intranet.service.WorkExperienceLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.shuntian.portlet.intranet.service.impl.WorkExperienceLocalServiceImpl}.
 * </p>
 *
...
public abstract class WorkExperienceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WorkExperienceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.shuntian.portlet.intranet.service.WorkExperienceLocalServiceUtil} to access the work experience local service.
	 */
	 ...
	 */
	@Override
	public WorkExperience createWorkExperience(long id) {
		return workExperiencePersistence.create(id);
	}
	...
	public WorkExperience deleteWorkExperience(long id)
		...
		return workExperiencePersistence.remove(id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WorkExperience.class,
	...
	@Override
	public WorkExperience fetchWorkExperience(long id)
		throws SystemException {
		return workExperiencePersistence.fetchByPrimaryKey(id);
	}
	...
	public WorkExperience getWorkExperience(long id)
		throws PortalException, SystemException {
		return workExperiencePersistence.findByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public int getWorkExperiencesCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.shuntian.portlet.intranet.model.WorkExperience",
	...
	private WorkExperienceLocalServiceClpInvoker _clpInvoker = new WorkExperienceLocalServiceClpInvoker();
}